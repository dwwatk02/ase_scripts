...
class ase(object):  
   ...
   def getTemplatesList(self):
      ...
      #print r.text[3:]  
      root = defusedxml.ElementTree.fromstring(r.text[3:]) #Convert the response into a tree element.   
   ...
   #Start a new job  
      ...
      #print(r.text[3:])  
      root=defusedxml.ElementTree.fromstring(r.text[3:])  
...
##      print("Done")
   ...
   def getReportPackList(self, id):
      ...
      root = defusedxml.ElementTree.fromstring(response)
      list={} #create an empty list  
      for item in root:
   ...
   def getReportId(blank,reportsET,reportName):  
      reports=defusedxml.ElementTree.fromstring(reportsET)  
      for i in range(11):  
   ...
   def getFolders(self,parentFolder='-1'):  
      if(parentFolder=='-1'):
         ...
         root=defusedxml.ElementTree.fromstring(r.text[3:]) #Convert the response into an element tree  
